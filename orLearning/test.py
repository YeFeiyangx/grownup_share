...
print("len(job_durations):", len(job_durations))
...
print("len(setup_times):", len(setup_times))
print("len(setup_times[0]):", len(setup_times[0]))

due_dates = [
    -1, -1, 28569, -1, 98104, 27644, 55274, 57364, -1,    -1, 60875, 96637, 77888, -1, -1
]

print("len(due_dates):", len(due_dates))

release_dates = [
    0,  0,      0,  0, 19380,     0,     0, 48657,  0, 27932,     0,     0, 24876,  0,  0
]

print("len(release_dates):", len(release_dates))