...
def monte_carlo_off_policy(episodes):
    ...
    ## https://www.bilibili.com/video/BV1aE411o7qd?p=75 十分推荐
...
def figure_5_1():
    ...
    plt.savefig(os.path.join(os.path.abspath('.')+'\\images','figure_5_1.png'))
    plt.show()
    plt.close()
...
def figure_5_2():
    ...
    # plt.savefig(os.path.join(os.path.abspath('.')+'\\images','figure_5_2.png'))
    plt.show()
    plt.close()
...
def figure_5_3():
    ...
    plt.savefig(os.path.join(os.path.abspath('.')+'\\images','figure_5_3.png'))
    plt.show()
    plt.close()
